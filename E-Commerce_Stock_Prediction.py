...
st.title('Predicting  E-Commerce Stocks :')   #Title of our web-app
st.write('(Amazon, Ali Baba, Ebay, Walmart , Costco, Best Buy , The Home Deport , Etsy)')

stocks = ('AMZN','BABA','EBAY','WMT','COST','BBY','HD','ETSY')  #Stocks we are using to predict
